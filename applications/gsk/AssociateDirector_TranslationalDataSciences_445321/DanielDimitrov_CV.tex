...
{\Huge\bfseries\color{accent}DANIEL B.\ DIMITROV}\\[8pt]
{\small
\faEnvelope\; \href{mailto:daniel.boykov.dimitrov@gmail.com}{daniel.boykov.dimitrov@gmail.com}\sep
\faPhone*\; +49\,177\,705\,6912\\[3pt]
\faMapMarker*\; Heidelberg, Germany\sep
...
\raggedleft\raisebox{4pt}{\includegraphics[height=2.35cm]{photo.png}}\hspace*{6pt}
\end{minipage}
...
\vspace{9pt}
I build modelling frameworks that integrate single-cell, spatial and multi-omics data with
...
\begin{cvitems}
  \item Developing deep probabilistic models to infer perturbed
...
\textbf{ML:} PyTorch, PyG, scvi-tools\\[4pt]
\textbf{LLMs:} interpretability, feature steering; agentic workflows\\[4pt]
...
\section{Selected Publications and Preprints \normalsize\mdseries\upshape(out of 18; 4,000+ citations; \# co-first; * corresponding)}
...
Preprint; under review at \textit{NeurIPS 2026}.}
...
\pub{Farr, E.B.\#, \me\#, T\"urei, D., Schmidt, C., Lobentanzer, S., Dugourd, A. and Saez-Rodriguez, J.*, 2024.
...
\pub{\me, Sch\"afer, P.S.L., Farr, E.B., Rodriguez Mier, P., Lobentanzer, S., Dugourd, A., et al.\
...
\begin{cvitems}
  ...
  \item \textbf{Projects I co-conceived and currently lead:}
        \begin{itemize}[leftmargin=1.05em,itemsep=3pt,parsep=0pt,topsep=4pt,label={\color{accent}\scriptsize\textbullet}]
          \item \textbf{EHRx}: LLMs for autointerpretability of transformer foundation models of electronic health records
          \item \textbf{LIANA++}: extending cell-cell communication to single-cell resolution spatial technologies
          \item \textbf{Cellina}: a deep generative model for in silico perturbations of spatial tissue graphs
          \item \textbf{Cellina$\to$imaging}: extending graph and pathology foundation models for tissue perturbations
          \item \textbf{KIARA}: decomposing perturbation and niche-effect via residual learning in spatial omics
        \end{itemize}
