# References — Daniel Dimitrov

<!-- INTERNAL — never render into the submitted PDF.
Posting requirement: "names and addresses of three references." Referee 3 decided 2026-08-22 with the candidate: Yvan Saeys replaces Valdeolivas (round-1 committee: Valdeolivas is a Saez-lab alumnus, so the old trio read as two nodes of one Heidelberg network plus Stegle; Saeys is senior, methods-credible, and knows the work through the funded CZI collaboration). Before submission: confirm with Y.S. that he will write — and note the possible tie-in that the May 2026 VIB-IRC invited seminar may have been hosted by his orbit (cv_facts §3 host-PI slot still open). Round-2 committee: consider offering Valdeolivas proactively as an optional fourth (industry-adoption witness) in the cover email if AITHYRA permits, and cultivate one senior no-shared-funding adopter referee for the interview stage. "Prof. Dr." honorific for Saeys: confirm. -->

1. **Prof. Dr. Julio Saez-Rodriguez** (PhD supervisor)
